  ...
  <div class="bg-white rounded-xl p-6">
    ...
    <div class="py-6">
      <form @submit.prevent="uploadImage" class="space-y-4">
        <label class="block text-left mb-2 text-sm font-medium text-gray-900" for="file_input">Upload file</label>
        <input ref="fileInput" class="block w-full text-sm text-gray-900 border border-primary rounded-lg cursor-pointer bg-gray-50 focus:outline-none dark:bg-gray-700" id="file_input" type="file">
  ...
  export default {
    methods: {
      uploadImage() {
        ...
        formData.append('trx_photo', fileInput);
