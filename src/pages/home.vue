    ...
    <div class="p-6 rounded-xl bg-white h-80">
      ...
      <div class="mt-5">
        <table class="w-full table-auto text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                  <tr v-for="(latestCustomer, index ) in latestCustomers" :key="latestCustomer.id" class="bg-white border-b text-gray-900 dark:bg-gray-800 dark:border-gray-700">
